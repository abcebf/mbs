...
export class SeedConfig {
  ...
  */
   ...
   * @type {string}
   */
  APP_BASE = argv['base'] || '/bonuscampaign/';
   ...
   * @type {string}
   */
  APP_TITLE = 'Welcome to Bonus Campaign Editor!';
  ...
  PROD_DEST = `../../build/resources/main/static`;
  ...
  SYSTEM_CONFIG_DEV: any = {
    ...
    packageConfigPaths: [
      `/bonuscampaign/node_modules/*/package.json`,
      `/bonuscampaign/node_modules/**/package.json`,
      `/bonuscampaign/node_modules/@angular/*/package.json`
    ],
    paths: {
